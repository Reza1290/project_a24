...
async function exportToExcelTriwulan(data, fileName) {
    ...
    sheet.mergeCells('G1:N1'); // Realisasi Kinerja Pada Triwulan
    sheet.mergeCells('G2:H2'); // TRIWULAN 1
    sheet.mergeCells('I2:J2'); // TRIWULAN 2
    sheet.mergeCells('K2:L2'); // TRIWULAN 1
    sheet.mergeCells('M2:N2'); // TRIWULAN 2
    sheet.mergeCells('O1:P3'); // Realisasi Pencapaian Kinerja dan Anggaran Renja
    sheet.mergeCells('Q1:R3'); // Tingkat Capainkinerja dan anggaran renja
    ...
    sheet.getCell('O1').value = 'Realisasi Pencapaian Kinerja dan Anggaran Renja';
    sheet.getCell('Q1').value = 'Tingkat Capaian kinerja dan anggaran renja';
    //triwulan header
    sheet.getCell('G2').value = 'TRIWULAN 1';
    sheet.getCell('I2').value = 'TRIWULAN 2';
    sheet.getCell('K2').value = 'TRIWULAN 3';
    sheet.getCell('M2').value = 'TRIWULAN 4';
    // Second-row headers
    ...
    sheet.getCell('K3').value = 'K';
    sheet.getCell('L3').value = 'Rp';
    sheet.getCell('M3').value = 'K';
    sheet.getCell('N3').value = 'Rp';
    ...
    sheet.getCell('K4').value = '10';
    sheet.getCell('L4').value = '11';
    sheet.getCell('M4').value = '12';
    sheet.getCell('N4').value = '13';
    sheet.getCell('O4').value = 'K';
    sheet.getCell('P4').value = 'Rp';
    sheet.getCell('Q4').value = 'K';
    sheet.getCell('R4').value = 'Rp';
    ...
    sheet.columns = [
        ...
        { key: 'triwulan_3_target_kinerja', width: 15 },
        { key: 'triwulan_3_realisasi_kinerja', width: 15 },
        { key: 'triwulan_4_target_kinerja', width: 15 },
        { key: 'triwulan_4_realisasi_kinerja', width: 15 },
    ...
    finalData.forEach(row => {
        ...
        const currentRow = sheet.addRow({
            program_kegiatan: row.nama_program + ', ' + row.nama_kegiatan + ' DAN ' + row.nama_sub_kegiatan,
