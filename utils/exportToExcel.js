...
data.forEach((row, index) => {
  ...
  const currentRow = sheet.addRow({
    ...
    target_anggaran: "Rp. " + row.k_target.toLocaleString('id-ID') ,
    realisasi_anggaran: "Rp. " + row.realisasi_anggaran.toLocaleString('id-ID'),
    capaian_anggaran: capaianAnggaran,
    target_kinerja: row.realisasi_kinerja + ' ' + row.satuan_sub_kegiatan,
    realisasi_kinerja: row.sk_target + ' ' + row.satuan_sub_kegiatan,
